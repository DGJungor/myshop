...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  <tr>
    <td width="99%" align="left" valign="top">您的位置：会员管理&nbsp;&nbsp;>&nbsp;&nbsp;会员信息</td>
  </tr>
  <tr>
...
<?php 
  ...
  foreach($list as $row){
    ...
    if($row['id']==1){
      echo "<td align='center' valign='middle' class='borderbottom'>无法操作</td>";
    }else{
         echo "<td align='center' valign='middle' class='borderbottom'><a a href='edit.php?id={$row['id']}' target='mainFrame' onFocus='this.blur()' class='add'>编辑</a><span class='gray'>&nbsp;"."|";

        if($_SESSION['adminuser']['id']==$row['id']){
          echo "&nbsp;</span>无法删除</td>";

        }else{
         echo "&nbsp;</span><a href='action.php?a=del&id={$row['id']}' target='mainFrame' onFocus='this.blur()' class='add'>删除</a></td>";
        }
