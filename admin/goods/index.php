...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  <tr>
    <td width="99%" align="left" valign="top">您的位置：商品管理&nbsp;&nbsp;>&nbsp;&nbsp;浏览商品信息</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      <tr>
        ...
        <th align="center" valign="middle" class="borderright">销售量</th>
        <th align="center" valign="middle" class="borderright">点击量</th>
...
<?php 
  ...
  // $a = $mod->select();
   ...
   $page = new Page($total,7);
    ...
    $from = "goods g,type t"; 
    $where= "g.typeid=t.id";
    $list = $mod->limit($page->limit())->where($where)->select_s($select,$from);
  ...
  foreach($list as $row){
    ...
    echo "<td align='center' valign='middle' class='borderright borderbottom'>{$row['store']}</td>";
    echo "<td align='center' valign='middle' class='borderright borderbottom'>{$row['num']}</td>";
    echo "<td align='center' valign='middle' class='borderright borderbottom'>{$row['clicknum']}</td>";
    ...
    echo "<td align='center' valign='middle' class='borderbottom'><a href='edit.php?id={$row['id']}' target='mainFrame' onFocus='this.blur()' class='add'>编辑</a><span class='gray'>&nbsp;"."|"."&nbsp;</span><a href='action.php?a=del&id={$row['id']}&picname={$row['picname']}' target='mainFrame' onFocus='this.blur()' class='add'>删除</a></td>";
    echo "</tr>";
  }
