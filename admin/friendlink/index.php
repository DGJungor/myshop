...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  <tr>
    <td width="99%" align="left" valign="top">您的位置：友情连接管理&nbsp;&nbsp;>&nbsp;&nbsp;友情连接信息</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      <tr>
        ...
        <th align="center" valign="middle" class="borderright">站名</th>
        <th align="center" valign="middle" class="borderright">连接</th>
...
<?php 
  ...
  foreach($list as $row){
    ...
    echo "<td align='center' valign='middle' class='borderright borderbottom'>{$row['linkname']}</td>";
    echo "<td align='center' valign='middle' class='borderright borderbottom'>{$row['link']}</td>";
    echo "<td align='center' valign='middle' class='borderright borderbottom'>{$state[$row['state']]}</td>";   


    echo "<td align='center' valign='middle' class='borderbottom'><a a href='edit.php?id={$row['id']}' target='mainFrame' onFocus='this.blur()' class='add'>编辑</a><span class='gray'>&nbsp;"."|"."&nbsp;</span><a href='action.php?a=del&id={$row['id']}' target='mainFrame' onFocus='this.blur()' class='add'>删除</a></td>";
    echo "</tr>";
  }
