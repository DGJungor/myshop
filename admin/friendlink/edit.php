...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  <tr>
    <td width="99%" align="left" valign="top">您的位置：友情连接管理&nbsp;&nbsp;>&nbsp;&nbsp;修改友情连接</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        <td align="right" valign="middle" class="borderright borderbottom bggray">站名:</td>
        <td align="left" valign="middle" class="borderright borderbottom main-for">
        <input type="text" name="linkname" value="<?php echo $flink['linkname']; ?>" class="text-word">
        </td>
      </tr>
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        <td align="right" valign="middle" class="borderright borderbottom bggray">连接：</td>
        <td align="left" valign="middle" class="borderright borderbottom main-for">
        <input type="text" name="link" value="<?php echo $flink['link']; ?>" class="text-word">
        </td>
      </tr>
      ...
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
	    ...
	    <option value="1" <?php echo ($flink['state']==1)? "selected='selected'":'' ?> >&nbsp;&nbsp;启用</option>
	    <option value="2" <?php echo ($flink['state']==2)? "selected='selected'":'' ?> >&nbsp;&nbsp;停用</option>	  
        </select>
        </td>
      </tr>
