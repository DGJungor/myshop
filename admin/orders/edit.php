...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  <tr>
    <td width="99%" align="left" valign="top">您的位置：订单管理&nbsp;&nbsp;>&nbsp;&nbsp;编辑订单信息</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      ...
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <td align="left" valign="middle" class="borderright borderbottom main-for">
        <input type="text" name="linkman" value="<?php echo $orders['linkman']; ?>" class="text-word">
        </td>
      </tr>
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        <td align="right" valign="middle" class="borderright borderbottom bggray">地址：</td>
        <td align="left" valign="middle" class="borderright borderbottom main-for">
        <input type="text" name="address" value="<?php echo $orders['address']; ?>" class="text-word">
        </td>
      </tr>
      ...
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <td align="left" valign="middle" class="borderright borderbottom main-for">
        <input type="text" name="code" value="<?php echo $orders['code']; ?>" class="text-word">
        </td>
        </tr>
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        <td align="right" valign="middle" class="borderright borderbottom bggray">电话：</td>
        <td align="left" valign="middle" class="borderright borderbottom main-for">
        <input type="text" name="phone" value="<?php echo $orders['phone']; ?>" class="text-word">
        </td>
      </tr>
      ...
      <option value="0" <?php echo ($orders['status']==0)? "selected='selected'":'' ?> >&nbsp;&nbsp;新订单</option>
      <option value="1" <?php echo ($orders['status']==1)? "selected='selected'":'' ?> >&nbsp;&nbsp;已发货</option>
      <option value="2" <?php echo ($orders['status']==2)? "selected='selected'":'' ?> >&nbsp;&nbsp;已经收货</option>
      <option value="3" <?php echo ($orders['status']==3)? "selected='selected'":'' ?> >&nbsp;&nbsp;无效订单</option>
