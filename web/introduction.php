					...
					<div class="clearfixLeft" id="clearcontent">
						...
						<div class="box">
							...
							<div class="tb-booth tb-pic tb-s310">
								...
								<?php 
								echo "<a href=\"../public/uploads/{$goods['0']['picname']}\"><img src=\"../public/uploads/m_{$goods['0']['picname']}\" alt=\"细节展示放大镜特效\" rel=\"../public/uploads/{$goods['0']['picname']}\" class=\"jqzoom\" /></a>";
								?>
						...
						<div class="tb-detail-list">
							...
							<div class="tb-detail-price">
								<li class="price iteminfo_price">
									<dt>促销价</dt>
									<dd><em>¥</em><b class="sys_item_price">暂无促销活动</b>  </dd>                                 
								</li>
								<li class="price iteminfo_mktprice">
									<dt>原价</dt>
									<dd><em>¥</em><b class=""><?php echo "{$goods['0']['price']}"; ?></b></dd>									
								</li>
								<div class="clear"></div>
							</div>
							...
							<ul class="tm-ind-panel">
								...
								<li class="tm-ind-item tm-ind-sumCount canClick">
									<div class="tm-indcon"><span class="tm-label">累计销量</span><span class="tm-count"><?php echo "{$goods['0']['num']}";?></span></div>
								</li>
								...
								<dd>
									...
									<div class="theme-popover">
										...
										<div class="theme-popbod dform">
											<form class="theme-signin" name="loginform" action="./cartaction.php?a=add" method="post">
												...
												<div class="theme-signin-left">
													...
													<div class="theme-options">
														...
														<dd>
															...
															<input id="text_box" name="addnum" type="text" value="1" style="width:30px;" />
															<input id="add" class="am-btn am-btn-default" name="" type="button" value="+" />
															<span id="Stock" class="tb-hidden">库存<span class="stock"><?php echo "{$goods['0']['store']}";?></span>件</span>
														</dd>
						...
						<div class="pay">
							...
							<li>
								<div class="clearfix tb-btn tb-btn-buy theme-login">
									<!-- <input name="" type="submit" value="&nbsp&nbsp立即购买&nbsp&nbsp" id="LikBuy" > -->
							...
							<li>
								<div class="clearfix tb-btn tb-btn-basket theme-login">
									...
									<!-- <a id="LikBasket" title="加入购物车" href="./cartaction.php?a=add"><i></i>加入购物车</a> -->
									<input name="" type="submit" value="&nbsp&nbsp加入购物车&nbsp&nbsp" class="am-btn am-btn-danger">
								</div> 
