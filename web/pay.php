		...
		<!--顶部导航条 -->
			...
			<div class="concent">
				...
				<div class="paycont">
                   ...
                   <span class="buy-user"><?php echo $_SESSION['adminuser']['name'];?> </span>
										<span class="buy-phone"><?php echo $_SESSION['adminuser']['phone'];?></span>
										</span>
									</div>
									<div class="default-address DefaultAddr">
										<span class="buy-line-title buy-line-title-type">收货地址：<?php echo $_SESSION['adminuser']['address'];?></span>
										<span class="buy--address-detail">
										...
										<ul class="item-content clearfix">
												...
												<li class="td td-item">
													<div class="item-pic">
														<a href="#" class="J_MakePoint">
															<img src="../public/uploads/s_<?php echo $shop['picname'];?>"></a>
													</div>
													<div class="item-info">
														<div class="item-basic-info">
															<a href="./introduction.php?id=<?php echo $shop['id'];?>" class="item-title J_MakePoint" data-point="tbcart.8.11"><?php echo $shop['name'];?></a>
														</div>
													</div>
												</li>
												<li class="td td-info">
													<div class="item-props">
														...
														<span class="sku-line">包装：</span>
													</div>
												</li>
												<li class="td td-price">
													<div class="item-price price-promo-promo">
														<div class="price-content">
															<em class="J_Price price-now">¥ <?php echo $shop['price'];?></em>
														</div>
													</div>
												</li>
											</div>
												...
												<div class="amount-wrapper ">
													<div class="item-amount ">
														...
														<div class="sl">
															...
															<input class="text_box" name="num" type="text" value="" style="width:30px;" />
											...
											<li class="td td-oplist">
												<div class="td-inner">
													...
													<div class="pay-logis">
														快递:<b class="sys_item_freprice">免邮</b>
													</div>
												</div>
											</li>
								...
								<div class="pay-confirm clearfix">
									...
									<div id="holyshit269" class="submitOrder">
										<div class="go-btn-wrap">
											<a id="J_Go" href="./payaction.php?a=buy" class="btn-go" tabindex="0" title="点击此按钮，提交订单">提交订单</a>
										</div>
									</div>
									<div class="clear"></div>
								</div>
